                ...
                <div class="modal-body">
                    <form id="securityForm" method="POST" action="verify_security.php">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="answer2" name="answer2" autocomplete="off" required>
                        </div>
                        <div class="form-group">
                            <label for="answer3">What is your last name?</label>
                            <input type="text" class="form-control" id="answer3" name="answer3" autocomplete="off" required>
                        </div>
