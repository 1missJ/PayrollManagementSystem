    ...
    <main class="content">
       ...
       <div class="Branch-form">
        ...
        <form method="POST" action="branch.php">
            ...
            <input type="text" id="department-manager" name="department_manager" required placeholder="Enter Department Manager">
            <label for="department-address">Department Address</label>
            <input type="text" id="department-address" name="department_address" required placeholder="Enter Department Address">
