...
if (isset($_GET['delete'])) {
    ...
    $conn->query("DELETE FROM deduction WHERE employee_id = $id");
...
<?php include_once("./includes/sidebar.php"); ?>
    ...
    <form method="GET" action="employee.php">
        <input type="text" name="search" placeholder="Search by Name" class="search-bar" value="<?= htmlspecialchars($search_query) ?>">
    ...
    <a href="employee.php?delete=<?= $row['id'] ?>" class="delete" onclick="return confirm('Are you sure you want to delete this employee?');">
        <img src="./assets/images/delete.png" alt="delete" style="height: 20px; width: 25px; padding-top: 3px">
    </a>
</td>
